...
const Rental = () => {
  ...
  useEffect(() => {
    supabase
      ...
      .select("id, title, subtitle, transfer_type, description, image_urls")
      .eq("listing_type", "transfers")
      ...
      <div className="max-w-6xl mx-auto py-12 md:py-14 md:pt-24 px-7 md:px-12 2xl:px-0 flex flex-col gap-6">
        <div className="flex items-end justify-between">
          <div>
            ...
            >
              Rental Offerings <ChevronRight size={22} />
            </Link>
            <p className="text-[11px] text-gray-500 tracking-wide">
              Explore the most sought-after rental options curated for every
          ...
          {rentals.map((rental) => (
            ...
            >
              ...
              <div className="pt-3 px-0.5 flex flex-col gap-0.5">
                <Link
                  href={`/travel/listing?id=${rental.id}&type=ride`}
